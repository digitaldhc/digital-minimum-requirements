...
| DIMR\_DA\_5 | Data management | Where a solution produces security logs, the solution SHOULD be capable of being configured for those logs to be retained for up to 180 days. The solution SHOULD further permit export to or extraction by modern security information and event management (SIEM) solutions. | Yes | Yes | Yes |
